...
def analyze_and_share():
    ...
    try:
        ...
        prompt_linkedin = f"""You are an expert developer and a viral tech influencer on LinkedIn. Analyze the following project files and write a highly engaging, visually attractive LinkedIn post announcing this project. 
    Focus on:
    ...
    {code_context}"""
        ...
        prompt_readme = f"""You are an expert developer and technical writer. Analyze the following project files and write a highly attractive, comprehensive, and professional README.md for this repository.

...
def analyze_and_share():
    try:
        ...
        try:
            ...
            prompt_linkedin = f"""You are an elite Developer Advocate and Tech Influencer. Your goal is to write a highly viral, professional LinkedIn post announcing the completion of this specific project.
            You MUST deeply analyze the provided Project Context and extract the ACTUAL technical details, datasets, dashboard features, or code structures used. Do NOT write generic placeholder text.

            Structure the post exactly like this:
            1. 🚀 **The Hook:** A bold, scroll-stopping 1-sentence opening about the specific problem this project solves.
            2. 💡 **The Breakdown:** 2-3 short sentences explaining exactly what you built based on the extracted files.
            3. 🛠️ **Tech Deep-Dive:** A bulleted list of the specific technologies found in the context, along with how they were used (e.g., '🟢 **Pandas** for rigorous data cleaning' or '📊 **Power BI** for interactive visualizations').
            4. 📈 **Key Features/Insights:** 3 distinct bullet points highlighting the most impressive functional parts of the code or dashboard data.
            5. 🤝 **Call to Action:** Point them directly to the GitHub link to view the code, and ask a specific networking question to drive comments.

            Use generous line breaks for readability and highly relevant tech hashtags. Output ONLY the raw post content. No pre-text or post-text.
